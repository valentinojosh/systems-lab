...
6. enable supported memory profiles or performance settings after the stock baseline is stable.
...
- rerun functional validation after provisioning.
...
- Record a sanitized baseline of firmware, drivers, thermals, and representative performance.
